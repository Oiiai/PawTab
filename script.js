        ...
        function performSearch() {
            ...
            if (query === "") {
                // 简单微提示，但无侵入感，或者聚焦后无搜索就轻提醒
                searchInput.placeholder = "Here is nothing but our chicken~";
                searchInput.style.borderColor = "#ffb3b3";
                setTimeout(() => {
            ...
            // 使用百度搜索（UTF-8编码） 也可以使用 https://www.google.com/search?q= 
            // 现代浏览器默认在新标签页打开，符合新标签页跳转预期
